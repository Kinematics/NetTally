...
namespace NetTally.Adapters
{
    public class XenForoAdapter : IForumAdapter
    {
        ...
        public string GetTextOfPost(HtmlNode post)
        {
            ...
            var exclusions = Utility.GetClassesExclusionPredicate(new List<string>() { "bbCodeQuote", "messageTextEndMarker" });

            // Get the full post text.
            return Utility.ExtractPostText(postNode, exclusions);
        }
