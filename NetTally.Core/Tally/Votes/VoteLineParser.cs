...
namespace NetTally.Votes
{
    public static class VoteLineParser
    {
        ...
        {
            return StripBBCodeNoBuffer(input);
        }

        /// <summary>
        /// Version of the StripBBCode function that doesn't use any buffering.
        /// Used because slice support not available in .NET Core 2.0.
        /// </summary>
        /// <param name="input"></param>
        /// <returns></returns>
        private static string StripBBCodeNoBuffer(ReadOnlySpan<char> input)
        {
            if (input.Length == 0)
                return "";
