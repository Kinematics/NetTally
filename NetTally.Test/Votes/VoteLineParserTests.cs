...
namespace NetTally.Tests.Votes
{
    ...
    public class VoteLineParserTests
    {
        ...
        public void NonVote_1()
        {
            ...
            VoteLine voteLine = VoteLineParser.ParseLine(line.AsSpan());
        ...
        public void Strip_BBCode_None()
        {
            ...
            string result = VoteLineParser.StripBBCode(cleanExample.AsSpan());
        ...
        public void Strip_BBCode_Basic()
        {
            ...
            string result = VoteLineParser.StripBBCode(mediumExample.AsSpan());
            Assert.AreEqual(cleanExample, result);
        }
        ...
        public void Strip_BBCode_More()
        {
            ...
            string result = VoteLineParser.StripBBCode(largeExample.AsSpan());
            Assert.AreEqual(cleanExample, result);
        }
        ...
        public void Strip_BBCode_Image_Url()
        {
            ...
            string result = VoteLineParser.StripBBCode(imageExample.AsSpan());
        ...
        public void Strip_BBCode_UserRef_Url()
        {
            ...
            string result = VoteLineParser.StripBBCode(urlExample.AsSpan());
            Assert.AreEqual(clean, result);
        }
