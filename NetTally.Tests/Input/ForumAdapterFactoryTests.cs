...
namespace NetTally.Tests.Forums
{
    ...
    public class ForumAdapterFactoryTests
    {
        ...
        {
            Quest quest = new Quest { ThreadName = "http://forums.sufficientvelocity.com/threads/vote-tally-program.199/" };
        ...
        {
            Quest quest = new Quest { ThreadName = "https://forums.spacebattles.com/threads/vote-tally-program-v3.260204/" };
            var adapter = await forumAdapterFactory.CreateForumAdapterAsync(quest, pageProvider, CancellationToken.None);
        ...
        {
            Quest quest = new Quest { ThreadName = "https://forum.questionablequesting.com/threads/qq-vote-tally-program.1065/" };
            var adapter = await forumAdapterFactory.CreateForumAdapterAsync(quest, pageProvider, CancellationToken.None);
        ...
        {
            Quest quest = new Quest { ThreadName = "http://forums.animesuki.com/showthread.php?t=128882" };
            var adapter = await forumAdapterFactory.CreateForumAdapterAsync(quest, pageProvider, CancellationToken.None);
        ...
        public async Task Select_vBulletin4()
        {
            ...
            Quest quest = new Quest { ThreadName = "http://www.fandompost.com/oldforums/showthread.php?48716-One-Punch-Man-Discussion-Thread/page1" };
            var adapter = await forumAdapterFactory.CreateForumAdapterAsync(quest, pageProvider, CancellationToken.None);
        ...
        {
            Quest quest = new Quest { ThreadName = "http://www.vbulletin.com/forum/forum/vbulletin-announcements/vbulletin-announcements_aa/4333101-vbulletin-5-1-10-connect-is-now-available" };
            var adapter = await forumAdapterFactory.CreateForumAdapterAsync(quest, pageProvider, CancellationToken.None);
        ...
        {
            Quest quest = new Quest { ThreadName = "https://community.nodebb.org/topic/6298/nodebb-v0-7-3" };
            var adapter = await forumAdapterFactory.CreateForumAdapterAsync(quest, pageProvider, CancellationToken.None);
        ...
        {
            Quest quest = new Quest { ThreadName = "http://www.ilovephilosophy.com/viewtopic.php?f=1&t=175054" };
            var adapter = await forumAdapterFactory.CreateForumAdapterAsync(quest, pageProvider, CancellationToken.None);
