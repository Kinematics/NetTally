...
namespace NetTally
{
    ...
    public static class ErrorLog
    {
        ...
        public static string Log(Exception e) => Log(exception: e);
        ...
        public static string Log(string message = null, Exception exception = null)
        {
            try
            {
                ...
                string output = ComposeOutput(message, exception);
                if (output == null)
                    return null;
        ...
        private static string ComposeOutput(string message, Exception ex)
        {
            try
            {
